...
import io.tmgg.commons.poi.handler.inter.IExcelVerifyHandler;
import io.tmgg.commons.poi.handler.inter.IPoiFileHandler;
import lombok.Data;
...
public class ImportParams extends ExcelBaseParams {
     ...
     * 文件保存处理接口
     */
    private IPoiFileHandler     poiFileHandler;
    /**
