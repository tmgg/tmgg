...
public class ExcelBuilder {
    ...
    public static ExcelBuilder create(Workbook workbook) {
        ExcelBuilder eb = new ExcelBuilder();
        eb.workbook = workbook;
        eb.sheet = eb.workbook.createSheet();
    ...
    public static ExcelBuilder create(Workbook workbook,Sheet sheet) {
        ExcelBuilder eb = new ExcelBuilder();
        eb.workbook = workbook;
        eb.sheet = sheet;
    ...
    public static ExcelBuilder create(Workbook workbook,Sheet sheet,CellStyle centerStyle) {
        ExcelBuilder eb = new ExcelBuilder();
        eb.workbook = workbook;
        eb.sheet = sheet;
        eb.centerStyle = centerStyle;
        return eb;
    }
