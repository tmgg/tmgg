 ...
 *
 **/
public class PastTimeFormatTool {
    ...
    public static String formatPastTime(LocalDateTime time) {
        if(time == null){
            return null;
        }
        Date date = LocalTimeTool.localDateTimeToDate(time);
        return PastTimeFormatTool.formatPastTime(date);
    }
