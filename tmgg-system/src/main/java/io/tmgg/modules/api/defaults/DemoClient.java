...
public class DemoClient {
    ...
    public static void main(String[] args) {
        ...
        // 签名
        {
            String signResult = SecureUtil.md5(uri + appKey + timestamp + data);
