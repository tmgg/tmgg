...
public class SysAssetController  extends BaseController<SysAsset>{
    ...
    @GetMapping("preview/{name}" ) // 可以加后缀，如 /sysAsset/preview/bg.png
    public void preview(@PathVariable String name, HttpServletResponse resp, HttpServletRequest req) throws Exception {
        service.preview(name, req, resp);
    }
}
