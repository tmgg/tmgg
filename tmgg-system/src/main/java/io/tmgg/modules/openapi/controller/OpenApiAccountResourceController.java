...
public class OpenApiAccountResourceController  extends BaseController<OpenApiAccountResource>{

    @Resource
    OpenApiAccountResourceService service;
    ...
    public AjaxResult page(@RequestBody  CommonQueryParam param,  @PageableDefault(direction = Sort.Direction.DESC, sort = "updateTime") Pageable pageable) throws Exception {
        ...
        Page<OpenApiAccountResource> page = service.findAll(q, pageable);
